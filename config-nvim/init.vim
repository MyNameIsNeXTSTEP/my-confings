...
local servers = { 'typescript-language-server', 'pyright', 'rust_analyzer' }
...
hi CursorLine ctermfg=Black ctermbg=Green cterm=bold guifg=Black guibg=darkorchid1 gui=bold
hi Visual  guifg=#FFFFFF guibg=#BF3EFF gui=none
